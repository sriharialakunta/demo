...
public class GlobalExceptionHandler {
	...
	@ExceptionHandler(MailAlreadyExitsException.class)
	@ResponseStatus(value = HttpStatus.CONFLICT)
	@ResponseBody ExceptionResponse handleMailAlreadyExitsException(MailAlreadyExitsException exception, HttpServletRequest request)
	{
		ExceptionResponse myResponse = new ExceptionResponse();
		myResponse.setErrorMessage(exception.getMessage());
		myResponse.setRequestedURI(request.getRequestURI());
